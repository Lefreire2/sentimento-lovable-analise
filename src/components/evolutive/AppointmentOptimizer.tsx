        ...
        {optimization && (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* Coluna Esquerda - Informações de Agendamento */}
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                    {getStatusIcon(optimization.agendamento_detectado || 'pendente')}
                    <span className="font-medium">
                      {optimization.agendamento_detectado || 'Pendente'}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-orange-50 dark:bg-orange-950/20 rounded-lg">
                    <span className="font-medium">
                      {optimization.ultima_etapa_alcancada || 'Contato Inicial'}
                    </span>
                  </div>
                </div>
              </div>

              {/* Coluna Direita - Análise e Estratégia */}
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-purple-50 dark:bg-purple-950/20 rounded-lg border-l-4 border-purple-500">
                    <span className="font-medium">
                      {optimization.termo_chave_conversao || 'Preço, Demonstração, Agendamento'}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-red-50 dark:bg-red-950/20 rounded-lg border-l-4 border-red-500">
                    <span className="text-sm">
                      {optimization.motivo_nao_conversao || 'Não identificado ainda'}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                    <p className="text-sm">
                      {optimization.resumo_atendimento || 'Lead demonstrou interesse inicial, necessário follow-up personalizado para agendamento.'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Script Personalizado - Full Width */}
            <div className="space-y-2">
