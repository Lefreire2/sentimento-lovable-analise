      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex justify-between">
            ...
            <Badge variant="outline">{data.intention.data.total_conversations}</Badge>
          </div>
          <div className="flex justify-between">
            <span>Taxa de Conversão:</span>
            <Badge variant="default">{data.intention.data.conversions.rate}%</Badge>
          </div>
          <div className="flex justify-between">
            <span>Sentimento Positivo:</span>
            <Badge variant="secondary">{data.intention.data.sentiment_analysis.positive_rate}%</Badge>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="space-y-2">
            <div className="flex justify-between">
              <span>Leads:</span>
              <span>{data.funnel.funnel_data.leads}</span>
            </div>
            <div className="flex justify-between">
              <span>Qualificados:</span>
              <span>{data.funnel.funnel_data.qualified}</span>
            </div>
            <div className="flex justify-between">
              <span>Agendamentos:</span>
              <span>{data.funnel.funnel_data.appointments}</span>
            </div>
            <div className="flex justify-between">
              <span>Conversões:</span>
              <span>{data.funnel.funnel_data.conversions}</span>
            </div>
          </div>
        </CardContent>
      </Card>
